...
Component.options.__file = "resources\\assets\\js\\components\\user\\header.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1b746f37", Component.options)
  } else {
    hotAPI.reload("data-v-1b746f37", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_user_index__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_user_home__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_user_home___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_user_home__);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
  mode: 'history',
  routes: [{ path: '/', component: __WEBPACK_IMPORTED_MODULE_2__components_user_index___default.a, name: 'index' }, { path: '/home', component: __WEBPACK_IMPORTED_MODULE_3__components_user_home___default.a, name: 'home' }, { path: '/contact', component: PageComponent('Contact'), name: 'contact' }, { path: '/logout', component: __WEBPACK_IMPORTED_MODULE_2__components_user_index___default.a, name: 'logout' }]
}));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_user_App_vue__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_user_App_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_user_App_vue__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_localstorage__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__store__ = __webpack_require__(50);
...
__WEBPACK_IMPORTED_MODULE_2_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_4_vue_localstorage___default.a);
__WEBPACK_IMPORTED_MODULE_2_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vee_validate__["a" /* default */]);
/**
...
/* harmony default export */ __webpack_exports__["default"] = (new __WEBPACK_IMPORTED_MODULE_2_vue___default.a({
  localStorage: {
    auth: {
      type: Boolean
    }
  ...
  render: function render(h) {
    return h(__WEBPACK_IMPORTED_MODULE_0__components_user_App_vue___default.a);
  }
}));
...
Component.options.__file = "resources\\assets\\js\\components\\user\\App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-420efcc7", Component.options)
  } else {
    hotAPI.reload("data-v-420efcc7", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    var userObj = this.$localStorage.get('auth');
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-420efcc7", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-383ddf98", Component.options)
  } else {
    hotAPI.reload("data-v-383ddf98", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__header_vue__ = __webpack_require__(13);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    'app-header': __WEBPACK_IMPORTED_MODULE_0__header_vue___default.a
  },
  data: function data() {
    return {
      crsf_token: '',
  ...
  watch: {
    'formRegister.txtName': function formRegisterTxtName() {
      this.regexUsername();
      if (this.formRegister.txtName.length >= 8) {
        this.checkUsername('/check-username', this.formRegister.txtName);
      }
    },
    'formRegister.email': function formRegisterEmail() {
      this.checkUsername('/check-email', this.formRegister.email);
    }
  },
  mounted: function mounted() {
    this.crsf_token = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
    this.loadDepartmentBusiness();
  },

  methods: {
    loadDepartmentBusiness: function loadDepartmentBusiness() {
      var _this = this;

      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/get_department_business').then(function (response) {
        _this.depts = response.data.department;
        _this.option_depts = _this.depts[0].dept_id; // selected when start
        _this.loadPositionBusiness(_this.option_depts);
      });
    },

    loadPositionBusiness: function loadPositionBusiness(id) {
      var _this2 = this;

      this.pos = []; // clear data before set data
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/get_position_business', { sendId: id }).then(function (response) {
        _this2.pos = response.data.position;
        if (_this2.pos.length >= 1) {
          _this2.option_pos = _this2.pos[0].pos_id; // selected when start
        }
      });
    },
    ...
    regexUsername: function regexUsername() {
      ...
      this.$validator.extend('customregex', {
        validate: function validate(value) {
          return (/^[a-z0-9]+$/.test(_this3.formRegister.txtName)
          );
        },
    ...
    checkUsername: function checkUsername(urlPost, getValue) {
      var isUnique = function isUnique() {
        return __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post(urlPost, { sendUser: getValue }).then(function (response) {
          return {
    ...
    saveRegister: function saveRegister() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default()({
        ...
        _this4.formRegister.modal_register = false;
        _this4.formRegister.loadButtonsave = false;
        _this4.afterRegisterClearText();
        _this4.clear_error_after_register = true;
      });
    },
    checkLogin: function checkLogin() {
      var _this5 = this;

      if (this.formLogin.login_username !== '' && this.formLogin.login_password !== '') {
        __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/login', {
          userName: this.formLogin.login_username,
          userPassword: this.formLogin.login_password,
          remember: this.formLogin.remember
        }).then(function (response) {
          if (response.data.status === false) {
            _this5.formLogin.warning_Login = "<div class='field has-text-centered mb-10'>" + "<div class='notification' style='background-color:#E0182D;'>" + "<p class='has-text-white'>Username or Password is incorrect.</p>" + '</div>' + '</div>';
          } else {
            _this5.$localStorage.set('auth', true);
            _this5.$router.go('/home');
          }
        });
      }
    },
    onClickModalRegister: function onClickModalRegister() {
      var _this6 = this;
      ...
      if (this.formRegister.modal_register === false) {
        ...
        setTimeout(function () {
          _this6.formRegister.modal_register = !_this6.formRegister.modal_register;
        }, 200);
      }
    },
    onClickModalLogin: function onClickModalLogin() {
      var _this7 = this;
      ...
      if (this.formLogin.modal_login === false) {
        ...
        this.modalEffect.zoomIn = false;
        setTimeout(function () {
          _this7.formLogin.modal_login = !_this7.formLogin.modal_login;
        }, 200);
      }
    },
    ...
    setFocusPhoneNumberOneInput: function setFocusPhoneNumberOneInput(event) {
      if (event.target.value.length === 3) {
        this.$refs.phonetwo.focus();
      }
    },
    setFocusPhoneNumberTwoInput: function setFocusPhoneNumberTwoInput(event) {
      if (event.target.value.length === 3) {
        this.$refs.phonethree.focus();
      }
    },
    clearAllTextInputAndClearErrorValidate: function clearAllTextInputAndClearErrorValidate() {
      var _this9 = this;

      Object.keys(this.warningForm).forEach(function (key, index) {
        _this9.warningForm[key] = false;
      });
      Object.keys(this.formRegister).forEach(function (key, index) {
        if (typeof _this9.formRegister[key] === 'string') {
          _this9.formRegister[key] = '';
        }
      });
      this.$validator.reset('form-1');
    },
    afterRegisterClearText: function afterRegisterClearText() {
  ...
  created: function created() {
    ...
    this.$nextTick(function () {
      __WEBPACK_IMPORTED_MODULE_1_axios___default()({
        ...
        _this.lastname = response.data.user.lastname;
      });
    });
  },
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "container lg-pt-20 lg-pb-20" }, [
    _vm._m(0),
    _vm._v(" "),
    _c(
      "div",
              ...
              directives: [
                {
                  name: "show",
                  rawName: "v-show",
                  value: _vm.userStore.authUser,
                  expression: "userStore.authUser"
                }
              ],
            ...
            [
              _c(
                ...
                [
                  _vm._v(
                    "\n            " +
                      _vm._s(_vm.name + " " + _vm.lastname) +
                      "\n          "
                  ),
                  _vm.shimmer
                    ? _c("span", {
                        class: { shimmer: _vm.shimmer },
                        staticStyle: { height: "7px", width: "150px" }
                      })
                    : _vm._e()
                ]
              ),
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "navbar-end link-effect-10" }, [
      _c(
        "a",
        {
  ...
  function() {
    ...
    return _c("div", { staticClass: "navbar-dropdown is-boxed" }, [
      ...
      _c(
        "a",
        { staticClass: "navbar-item is-active", attrs: { href: "/logout" } },
        [_vm._v("\n            Logout\n          ")]
      )
    ])
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1b746f37", module.exports)
  }
}
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "app" } }, [
    _c("section", { staticClass: "hero is-fullheight has-carousel" }, [
      _vm._m(0),
      _vm._v(" "),
      _c(
        "nav",
      ...
      _c("div", { staticClass: "hero-body" }, [
        _c("div", { staticClass: "container has-text-centered" }, [
          ...
          _c(
            "a",
            {
              staticClass: "button is-link is-outlined is-large ",
              on: { click: _vm.onClickModalLogin }
            },
            [_vm._v("Log in")]
          ),
          _vm._v(" "),
          _c(
            "a",
            {
              ...
              on: { click: _vm.onClickModalRegister }
            },
            [_vm._v("Register")]
          )
        ])
    ...
    _c(
      ...
      {
        ref: "registerForm",
        attrs: { id: "registerForm", "data-vv-scope": "form-1" },
        on: {
          submit: function($event) {
            $event.preventDefault()
            _vm.validateForm("form-1")
          }
        }
      },
      [
        _c("input", {
          ...
          domProps: { value: _vm.crsf_token }
        }),
        _vm._v(" "),
        _c(
          "div",
          {
            class: { modal: true, "is-active": _vm.formRegister.modal_register }
          },
          [
            _c("div", { staticClass: "modal-background" }),
            _vm._v(" "),
            _c("div", { class: _vm.modalEffect }, [
              ...
              _c(
                "section",
                {
                  staticClass: "modal-card-body pt-20 pr-35 pb-20 pl-25",
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "field pt-20" }, [
                    ...
                    _c("div", { staticClass: "control has-icons-right" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formRegister.txtName,
                            expression: "formRegister.txtName"
                          },
                          {
                            name: "validate",
                            rawName: "v-validate",
                            value: "required|min:8|unique|customregex",
                            expression: "'required|min:8|unique|customregex'"
                          }
                        ],
                        class: {
                          input: true,
                          "is-danger": _vm.errors.has("form-1.username"),
                          "is-success": _vm.warningForm.success_username
                        },
                        attrs: {
                          type: "text",
                        ...
                        domProps: { value: _vm.formRegister.txtName },
                        on: {
                          blur: function($event) {
                            _vm.warningForm.success_username = true
                          },
                          ...
                          directives: [
                            {
                              ...
                              value:
                                ...
                                _vm.warningForm.success_username == true,
                              expression:
                                "!errors.has('form-1.username') && warningForm.success_username == true"
                            }
                          ],
                          staticClass: "icon is-small is-right"
                        },
                    ...
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                            " +
                            _vm._s(_vm.errors.first("form-1.username")) +
                            "\n                        "
                        )
                      ]
                    )
                  ...
                  _c("div", { staticClass: "field" }, [
                    ...
                    _c("div", { staticClass: "control has-icons-right" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formRegister.regis_password,
                            expression: "formRegister.regis_password"
                          },
                          {
                            name: "validate",
                            rawName: "v-validate",
                        ...
                        class: {
                          ...
                          "is-success": _vm.warningForm.success_password
                        },
                        attrs: {
                          type: "password",
                        ...
                        domProps: { value: _vm.formRegister.regis_password },
                        on: {
                          blur: function($event) {
                            _vm.warningForm.success_password = true
                          },
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                          ...
                          directives: [
                            {
                              ...
                              value:
                                ...
                                _vm.warningForm.success_password == true,
                              expression:
                                "!errors.has('form-1.password') && warningForm.success_password == true"
                            }
                          ],
                          staticClass: "icon is-small is-right"
                        },
                    ...
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                            " +
                            _vm._s(_vm.errors.first("form-1.password")) +
                            "\n                        "
                        )
                      ]
                    )
                    ...
                    _c("div", { staticClass: "control has-icons-right" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formRegister.regis_confirm_password,
                            expression: "formRegister.regis_confirm_password"
                          },
                          {
                            name: "validate",
                            rawName: "v-validate",
                        ...
                        class: {
                          ...
                          "is-success": _vm.warningForm.success_confirmpas
                        },
                        attrs: {
                          type: "password",
                        ...
                        on: {
                          blur: function($event) {
                            _vm.warningForm.success_confirmpas = true
                          },
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                          ...
                          directives: [
                            {
                              ...
                              expression:
                                "errors.has('form-1.password_confirmation')"
                            }
                          ],
                          staticClass: "icon is-small is-right"
                        },
                          ...
                          directives: [
                            {
                              ...
                              expression:
                                "!errors.has('form-1.password_confirmation') && warningForm.success_confirmpas == true"
                            }
                          ],
                          staticClass: "icon is-small is-right"
                        },
                    ...
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                            " +
                            _vm._s(
                              _vm.errors.first("form-1.password_confirmation")
                            ) +
                            "\n                        "
                        )
                      ]
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "columns pt-20" }, [
                    _c("div", { staticClass: "column" }, [
                      _c("div", { staticClass: "field" }, [
                        ...
                        _c("div", { staticClass: "control has-icons-right" }, [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.formRegister.regis_realname,
                                expression: "formRegister.regis_realname"
                              },
                              {
                                name: "validate",
                                rawName: "v-validate",
                            ...
                            class: {
                              input: true,
                              "is-danger": _vm.errors.has("form-1.firstname"),
                              "is-success": _vm.warningForm.success_name
                            },
                            attrs: {
                              type: "text",
                            ...
                            on: {
                              blur: function($event) {
                                _vm.warningForm.success_name = true
                              },
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                              ...
                              directives: [
                                {
                                  name: "show",
                                  rawName: "v-show",
                                  value: _vm.errors.has("form-1.firstname"),
                                  expression: "errors.has('form-1.firstname')"
                                }
                              ],
                              staticClass: "icon is-small is-right"
                            },
                              ...
                              directives: [
                                {
                                  ...
                                  rawName: "v-show",
                                  value:
                                    !_vm.errors.has("form-1.firstname") &&
                                    _vm.warningForm.success_name == true,
                                  expression:
                                    "!errors.has('form-1.firstname') && warningForm.success_name == true"
                                }
                              ],
                              staticClass: "icon is-small is-right"
                            },
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            "\n                                " +
                              _vm._s(_vm.errors.first("form-1.firstname")) +
                              "\n                            "
                          )
                        ]
                      )
                    ...
                    _c("div", { staticClass: "column" }, [
                      _c("div", { staticClass: "field" }, [
                        ...
                        _c("div", { staticClass: "control has-icons-right" }, [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.formRegister.regis_lastname,
                                expression: "formRegister.regis_lastname"
                              },
                              {
                                name: "validate",
                                rawName: "v-validate",
                            ...
                            class: {
                              input: true,
                              "is-danger": _vm.errors.has("form-1.lastname"),
                              "is-success": _vm.warningForm.success_lastname
                            },
                            attrs: {
                              type: "text",
                              placeholder: "Realname",
                            ...
                            on: {
                              blur: function($event) {
                                _vm.warningForm.success_lastname = true
                              },
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                              ...
                              directives: [
                                {
                                  name: "show",
                                  rawName: "v-show",
                                  value: _vm.errors.has("form-1.lastname"),
                                  expression: "errors.has('form-1.lastname')"
                                }
                              ],
                              staticClass: "icon is-small is-right"
                            },
                              ...
                              directives: [
                                {
                                  ...
                                  rawName: "v-show",
                                  value:
                                    !_vm.errors.has("form-1.lastname") &&
                                    _vm.warningForm.success_lastname == true,
                                  expression:
                                    "!errors.has('form-1.lastname') && warningForm.success_lastname == true"
                                }
                              ],
                              staticClass: "icon is-small is-right"
                            },
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            "\n                                " +
                              _vm._s(_vm.errors.first("form-1.lastname")) +
                              "\n                            "
                          )
                        ]
                      )
                  ...
                  _c("div", { staticClass: "field" }, [
                    ...
                    _c("div", { staticClass: "control has-icons-right" }, [
                      _c("textarea", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formRegister.regis_address,
                            expression: "formRegister.regis_address"
                          },
                          {
                            name: "validate",
                            rawName: "v-validate",
                        ...
                        class: {
                          textarea: true,
                          "is-danger": _vm.errors.has("form-1.address"),
                          "is-success": _vm.warningForm.success_address
                        },
                        attrs: {
                          placeholder: "AW 2017 · SS 2017 · AW 2016 · Shops",
                          name: "address",
                          value: ""
                        },
                        domProps: { value: _vm.formRegister.regis_address },
                        on: {
                          blur: function($event) {
                            _vm.warningForm.success_address = true
                          },
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                          ...
                          directives: [
                            {
                              name: "show",
                              rawName: "v-show",
                              value: _vm.errors.has("form-1.address"),
                              expression: "errors.has('form-1.address')"
                            }
                          ],
                          staticClass: "icon is-small is-right"
                        },
                          ...
                          directives: [
                            {
                              ...
                              rawName: "v-show",
                              value:
                                !_vm.errors.has("form-1.address") &&
                                _vm.warningForm.success_address == true,
                              expression:
                                "!errors.has('form-1.address') && warningForm.success_address == true"
                            }
                          ],
                          staticClass: "icon is-small is-right"
                        },
                    ...
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                            " +
                            _vm._s(_vm.errors.first("form-1.address")) +
                            "\n                        "
                        )
                      ]
                    )
                  ...
                  _c("div", { staticClass: "field" }, [
                    ...
                    _c("div", { staticClass: "control" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formRegister.regis_phoneone,
                            expression: "formRegister.regis_phoneone"
                          },
                          {
                            name: "validate",
                            rawName: "v-validate",
                        ...
                        class: {
                          input: true,
                          "is-danger": _vm.errors.has("form-1.phoneone"),
                          "is-success": _vm.warningForm.success_telephone
                        },
                        staticStyle: { width: "50px" },
                        attrs: { name: "phoneone", maxlength: "3" },
                        domProps: { value: _vm.formRegister.regis_phoneone },
                        on: {
                          blur: function($event) {
                            _vm.warningForm.success_telephone = true
                          },
                          keyup: _vm.setFocusPhoneNumberOneInput,
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                      ...
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formRegister.regis_phonetwo,
                            expression: "formRegister.regis_phonetwo"
                          },
                          {
                            name: "validate",
                            rawName: "v-validate",
                        ...
                        class: {
                          "input ml-15": true,
                          "is-danger": _vm.errors.has("form-1.phonetwo"),
                          "is-success": _vm.warningForm.success_telephonetwo
                        },
                        staticStyle: { width: "50px" },
                        attrs: { name: "phonetwo", maxlength: "3" },
                        domProps: { value: _vm.formRegister.regis_phonetwo },
                        on: {
                          blur: function($event) {
                            _vm.warningForm.success_telephonetwo = true
                          },
                          keyup: _vm.setFocusPhoneNumberTwoInput,
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formRegister.regis_phonethree,
                            expression: "formRegister.regis_phonethree"
                          },
                          {
                            name: "validate",
                            rawName: "v-validate",
                            value: "required|numeric|min:4",
                            expression: "'required|numeric|min:4'"
                          }
                        ],
                        ref: "phonethree",
                        class: {
                          "input ml-15": true,
                          "is-danger": _vm.errors.has("form-1.phonethree"),
                          "is-success": _vm.warningForm.success_telephonethree
                        },
                        staticStyle: { width: "70px" },
                        attrs: { name: "phonethree", maxlength: "4" },
                        domProps: { value: _vm.formRegister.regis_phonethree },
                        on: {
                          blur: function($event) {
                            _vm.warningForm.success_telephonethree = true
                          },
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                  ...
                  _c("div", { staticClass: "field" }, [
                    ...
                    _c("div", { staticClass: "control has-icons-right" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formRegister.regis_bod,
                            expression: "formRegister.regis_bod"
                          },
                          {
                            name: "validate",
                            rawName: "v-validate",
                        ...
                        class: {
                          "calendar input": true,
                          "is-danger": _vm.errors.has("form-1.birthday"),
                          "is-success": _vm.warningForm.success_birthday
                        },
                        attrs: {
                        ...
                        domProps: { value: _vm.formRegister.regis_bod },
                        on: {
                          blur: function($event) {
                            _vm.warningForm.success_birthday = true
                          },
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                          ...
                          directives: [
                            {
                              name: "show",
                              rawName: "v-show",
                              value: _vm.errors.has("form-1.birthday"),
                              expression: "errors.has('form-1.birthday')"
                            }
                          ],
                          staticClass: "icon is-small is-right"
                        },
                          ...
                          directives: [
                            {
                              ...
                              rawName: "v-show",
                              value:
                                !_vm.errors.has("form-1.birthday") &&
                                _vm.warningForm.success_birthday == true,
                              expression:
                                "!errors.has('form-1.birthday') && warningForm.success_birthday == true"
                            }
                          ],
                          staticClass: "icon is-small is-right"
                        },
                    ...
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                            " +
                            _vm._s(_vm.errors.first("form-1.birthday")) +
                            "\n                        "
                        )
                      ]
                    )
                  ...
                  _c("div", { staticClass: "field" }, [
                    ...
                    _c("div", { staticClass: "control has-icons-right" }, [
                      _c("input", {
                        ...
                        class: {
                          ...
                          "is-success": _vm.warningForm.success_email
                        },
                        attrs: {
                        ...
                        on: {
                          blur: function($event) {
                            _vm.warningForm.success_email = true
                          },
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                          ...
                          directives: [
                            {
                              ...
                              value:
                                ...
                                _vm.warningForm.success_email == true,
                              expression:
                                "!errors.has('form-1.email') && warningForm.success_email == true"
                            }
                          ],
                          staticClass: "icon is-small is-right"
                        },
                    ...
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                            " +
                            _vm._s(_vm.errors.first("form-1.email")) +
                            "\n                        "
                        )
                      ]
                    )
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.option_depts,
                                expression: "option_depts"
                              }
                            ],
                            attrs: { name: "depts" },
                            on: {
                              change: [
                                function($event) {
                                  ...
                                  _vm.option_depts = $event.target.multiple
                                    ? $$selectedVal
                                    : $$selectedVal[0]
                                },
                                _vm.onChangeDepartment
                              ]
                            }
                          },
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "field" }, [
                    _c("label", { staticClass: "label" }, [_vm._v("Position")]),
                    _vm._v(" "),
                    _c("p", { staticClass: "control has-icons-left" }, [
                      _c("span", { staticClass: "select is-fullwidth" }, [
                        _c(
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.option_pos,
                                expression: "option_pos"
                              }
                            ],
                            attrs: { name: "pos" },
                            on: {
                              change: function($event) {
                                ...
                                _vm.option_pos = $event.target.multiple
                                  ? $$selectedVal
                                  : $$selectedVal[0]
                              }
                            }
                          },
                          _vm._l(_vm.pos, function(pos_data) {
                            return _c(
                              "option",
                              {
                                key: pos_data.pos_id,
                                domProps: { value: pos_data.pos_id }
                              },
                              [
                                _vm._v(
                                  "\n                                                  " +
                                    _vm._s(pos_data.pos_name) +
                                    "\n                                              "
                                )
                              ]
                            )
              ...
              _c(
                ...
                [
                  _c(
                    "button",
                    {
                      class: {
                        ...
                        "is-loading": _vm.formRegister.loadButtonsave
                      },
                      attrs: {
                  ...
                  _c("input", {
                    staticClass: "button",
                    attrs: { type: "reset" },
                    on: { click: _vm.clearAllTextInputAndClearErrorValidate }
                  })
                ]
              )
            ])
    ...
    _c(
      ...
      [
        _c(
          "div",
          { class: { modal: true, "is-active": _vm.formLogin.modal_login } },
          [
            _c("div", { staticClass: "modal-background" }),
            _vm._v(" "),
            _c("div", { class: _vm.modalEffect }, [
              ...
              _vm._v(" "),
              _c("section", { staticClass: "modal-card-body pt-15 pb-15" }, [
                _c("div", {
                  domProps: { innerHTML: _vm._s(_vm.formLogin.warning_Login) }
                }),
                _vm._v(" "),
                _c("div", { staticClass: "columns" }, [
                  _c(
                    ...
                    [
                      _c("div", { staticClass: "field" }, [
                        ...
                        _c("div", { staticClass: "control has-icons-right" }, [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.formLogin.login_username,
                                expression: "formLogin.login_username"
                              },
                              {
                                name: "validate",
                                rawName: "v-validate",
                            ...
                            domProps: { value: _vm.formLogin.login_username },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                              ...
                              directives: [
                                {
                                  ...
                                  expression:
                                    "errors.has('form-2.login_username')"
                                }
                              ],
                              staticClass: "icon is-small is-right"
                            },
                        ...
                        _c(
                            ...
                            directives: [
                              {
                                name: "show",
                                rawName: "v-show",
                                value: _vm.errors.has("form-2.login_username"),
                                expression:
                                  "errors.has('form-2.login_username')"
                              }
                            ],
                          ...
                          [
                            _vm._v(
                              "\n                                    " +
                                _vm._s(
                                  _vm.errors.first("form-2.login_username")
                                ) +
                                "\n                                "
                            )
                          ]
                      ...
                      _c("div", { staticClass: "field" }, [
                        ...
                        _c("div", { staticClass: "control has-icons-right" }, [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.formLogin.login_password,
                                expression: "formLogin.login_password"
                              },
                              {
                                name: "validate",
                                rawName: "v-validate",
                            ...
                            domProps: { value: _vm.formLogin.login_password },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                              ...
                              directives: [
                                {
                                  ...
                                  expression:
                                    "errors.has('form-2.login_password')"
                                }
                              ],
                              staticClass: "icon is-small is-right"
                            },
                        ...
                        _c(
                            ...
                            directives: [
                              {
                                name: "show",
                                rawName: "v-show",
                                value: _vm.errors.has("form-2.login_password"),
                                expression:
                                  "errors.has('form-2.login_password')"
                              }
                            ],
                          ...
                          [
                            _vm._v(
                              "\n                                    " +
                                _vm._s(
                                  _vm.errors.first("form-2.login_password")
                                ) +
                                "\n                                "
                            )
                          ]
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "field pt-5" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formLogin.remember,
                              expression: "formLogin.remember"
                            }
                          ],
                          ...
                          domProps: {
                            checked: Array.isArray(_vm.formLogin.remember)
                              ? _vm._i(_vm.formLogin.remember, null) > -1
                              : _vm.formLogin.remember
                          },
                          on: {
                            change: function($event) {
                              var $$a = _vm.formLogin.remember,
                                $$el = $event.target,
                              ...
                              if (Array.isArray($$a)) {
                                ...
                                _vm.$set(_vm.formLogin, "remember", $$c)
                              }
                            }
                          }
                        }),
                        ...
                        _c(
                          "label",
                          { attrs: { for: "switchRoundedSuccess" } },
                          [_vm._v("Remember me")]
                        )
                      ]),
                      _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      {
        staticClass: "hero-carousel carousel-animated carousel-animate-fade",
        attrs: { "data-autoplay": "true" }
      },
      [
        _c("div", { staticClass: "carousel-container" }, [
          _c("div", { staticClass: "carousel-item has-background is-active" }, [
            _c("img", {
              staticClass: "is-background",
              attrs: { src: "images/index_bg1.jpg", alt: "" }
            })
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "carousel-item has-background" }, [
            _c("img", {
              staticClass: "is-background",
              attrs: { src: "images/index_bg2.jpg", alt: "" }
            })
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "carousel-item has-background" }, [
            _c("img", {
              staticClass: "is-background",
              attrs: { src: "images/index_bg3.jpg", alt: "" }
            })
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "carousel-item has-background" }, [
            _c("img", {
              staticClass: "is-background",
              attrs: { src: "images/index_bg4.jpg", alt: "" }
            })
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "carousel-item has-background" }, [
            _c("img", {
              staticClass: "is-background",
              attrs: { src: "images/index_bg5.jpg", alt: "" }
            })
          ])
        ])
      ]
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "field pt-10" }, [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "column is-vcentered" }, [
      _c(
        "a",
        {
          staticClass: "btn-si btn-si-a btn-facebook",
          attrs: { href: "auth/login/facebook" }
        },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-383ddf98", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c7fff5ee", Component.options)
  } else {
    hotAPI.reload("data-v-c7fff5ee", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "app" } }, [
    _c(
      "nav",
      { staticClass: "navbar is-primary has-shadow" },
      [_c("app-header")],
      1
    ),
    _vm._v(" "),
    ...
    return _c("div", { staticClass: "container is-fullhd" }, [
      _c(
        ...
        [
          ...
          _c(
            "a",
            { staticClass: "button is-small is-primary", attrs: { href: "#" } },
            [_vm._v("Reserve Now")]
          )
        ]
      ),
      ...
      _c(
        "div",
        {
          staticClass: "carousel carousel-animate-fade carousel-animated",
          attrs: { "data-autoplay": "true" }
        },
        [
          _c(
            "div",
            {
              ...
              staticStyle: { height: "500.608px" }
            },
            [
              _c(
                "div",
                { staticClass: "carousel-item has-background is-active" },
                [
                  _c(
                    "a",
                    {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "carousel-navigation" }, [
            _c("div", { staticClass: "carousel-nav-left" }, [
              _c("i", {
            ...
            _vm._v(" "),
            _c("div", { staticClass: "carousel-nav-right" }, [
              _c("i", {
      ...
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "columns pt-30" }, [
          _c("div", { staticClass: "column is-8" }, [
            _c(
              ...
              [
                _c("ul", [
                  _c(
                    "li",
                    { staticClass: "is-active", attrs: { "data-tab": "1" } },
                    [_c("a", [_vm._v("News")])]
                  ),
                  _vm._v(" "),
                  _c("li", { attrs: { "data-tab": "2" } }, [
                    _c("a", [_vm._v("Informations")])
                  ]),
                  _vm._v(" "),
                  _c("li", { attrs: { "data-tab": "3" } }, [
                    _c("a", [_vm._v("Service")])
                  ]),
                  _vm._v(" "),
                  _c("li", { attrs: { "data-tab": "4" } }, [
                    _c("a", [_vm._v("Procurment")])
                  ])
                ])
              ]
            ),
            ...
            _c(
              "div",
              {
                staticClass: "pl-10 pt-15 pb-10",
                attrs: { id: "tab-content" }
              },
              [
                _c(
                  "div",
                  {
                    staticClass:
                      "columns header-columns is-active card has-background-white-bis pt-15 pb-15",
                    attrs: { "data-content": "1" }
                  },
                  [
                    _c(
                      "div",
                      ...
                      [
                        ...
                        _c(
                          "div",
                          { staticClass: "is-size-7 has-text-primary" },
                          [
                            _vm._v(
                              "\n                    2 Topics on this day.\n                  "
                            )
                          ]
                        )
                      ]
                ...
                _c(
                  "div",
                  {
                    staticClass: "columns header-columns",
                    attrs: { "data-content": "2" }
                  },
                  [
                    _c("article", { staticClass: "media" }, [
                      _c("div", { staticClass: "media-left" }, [
          ...
          _c("div", { staticClass: "column" }),
          _vm._v(" "),
          _c("div", { staticClass: "column is-3 has-text-centered box" }, [
            _vm._v("\n          Auto\n        ")
          ])
        ])
      ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c7fff5ee", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_user_userStore__ = __webpack_require__(51);




__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */]);
var debug = "development" !== 'productions';

/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
    modules: {
        userStore: __WEBPACK_IMPORTED_MODULE_2__components_user_userStore__["a" /* default */]
    },
    strict: debug
}));
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__router__ = __webpack_require__(32);
